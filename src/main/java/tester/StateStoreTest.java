...
public class StateStoreTest {
  ...
  public static void main(final String[] args) {
    ...
    final KStream<byte[], String> other = builder.stream("Other", Consumed.with(byteArraySerde, stringSerde));
    ...
    final KStream<byte[], String> anotherThing = other.mapValues(v -> v.toLowerCase());

    anotherThing.to("UppercasedTextLinesTopic");
